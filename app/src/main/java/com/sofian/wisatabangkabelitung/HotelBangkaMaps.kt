...
import kotlinx.android.synthetic.main.activity_hotel_bangka_maps.*

class HotelBangkaMaps : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hotel_bangka_maps)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(hotel_bangka,20f))
